...
export const MapSection = ({
	...
	return (
		...
		>
			<div
				className="absolute left-0 z-10 h-full backdrop-blur-[2px]"
				aria-hidden
			>
				<svg
				...
				>
					...
					<rect
						width="100%"
						height="100%"
						fill={`url(#${id}-diag-border-left)`}
					/>
				</svg>
			</div>
			<div
				className="absolute right-0 z-10 h-full backdrop-blur-[2px]"
				aria-hidden
			>
				<svg
					className="h-full w-8 border-r border-zinc-900 stroke-zinc-800 sm:w-20"
