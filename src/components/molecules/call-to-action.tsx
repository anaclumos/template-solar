...
export function CallToAction({ title, description, primary, secondary, imageSrc, imageAlt = '' }: CallToActionProps) {
  return (
    <section className="mx-auto max-w-6xl mt-10 mb-40 px-4 xl:px-0">
      <div className="grid items-center gap-8 sm:grid-cols-6">
        ...
        <div className="relative isolate rounded-xl sm:col-span-4 sm:h-full">
          ...
          />
          <Image alt={imageAlt} src={imageSrc} height={1000} width={1000} className="relative z-10 rounded-2xl" />
        </div>
      </div>
    </section>
  )
