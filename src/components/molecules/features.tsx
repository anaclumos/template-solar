...
export const Features = ({
  sectionAriaLabel = 'Hypany Startup Validation Features',
  id = 'solutions',
  blocks,
  orbitLabels,
}: FeaturesProps) => {
  const [first, second, third] = blocks
  const patternIdA = `${id}-diag-pattern-a`
  const patternIdB = `${id}-diag-pattern-b`
  const patternIdC = `${id}-diag-pattern-c`
  return (
    <section
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-12 md:grid-cols-4 md:gap-0">
        ...
        <div className="col-span-2 my-auto px-2">
          ...
          <p className="mt-4 text-balance text-gray-700">{first.description}</p>
        </div>
        <div className="relative col-span-2 flex items-center justify-center overflow-hidden">
          <svg className="absolute size-full [mask-image:linear-gradient(transparent,white_10rem)]" aria-hidden="true">
            <defs>
              <pattern id={patternIdA} patternUnits="userSpaceOnUse" width="64" height="64">
            ...
            <rect width="100%" height="100%" fill={`url(#${patternIdA})`} />
          </svg>
              ...
              <Orbit
                ...
                orbitingObjects={[
                  <div key="obj1" className="relative flex items-center justify-center">
                    <RiBarChartBoxFill className="z-10 size-5 text-gray-900" />
                    ...
                    <div className="absolute -top-5 left-4">
                      <div className="flex gap-1">
                        ...
                        <div className="rounded-r-full bg-white/50 py-0.5 pr-1.5 pl-1 text-xs whitespace-nowrap ring-1 ring-gray-200">
                          {orbitLabels[0]?.text || 'Low Conversion'}
                        </div>
                      </div>
                    </div>
                    <div
                  ...
                  <div key="obj2" className="relative flex items-center justify-center">
                    <RiFocusLine className="z-10 size-5 text-gray-900" />
                    <div className="absolute size-10 rounded-full bg-white/50 ring-1 shadow-lg ring-black/5"></div>
                    <div className="absolute -top-5 left-4">
                      <div className="flex gap-1">
                        ...
                        <div className="rounded-r-full bg-white/50 py-0.5 pr-1.5 pl-1 text-xs ring-1 ring-gray-200">
                          {orbitLabels[1]?.text || 'A/B Testing'}
                        </div>
                      </div>
                    </div>
                    <div
                  ...
                  <div key="obj3" className="relative flex items-center justify-center">
                    <RiUserSearchFill className="z-10 size-5 text-gray-900" />
                    <div className="absolute size-10 rounded-full bg-white/50 ring-1 shadow-lg ring-black/5"></div>
                    <div
                      style={{
                        animationDelay: '2s',
                  ...
                  <div key="obj4" className="relative flex items-center justify-center">
                    <RiLightbulbFlashFill className="z-10 size-5 text-gray-900" />
                    <div className="absolute size-10 rounded-full bg-white/50 ring-1 shadow-lg ring-black/5"></div>
                    <div className="absolute -top-5 left-4">
                      <div className="flex gap-1">
                  ...
                  <div key="obj5" className="relative flex items-center justify-center">
                    <RiRocketFill className="z-10 size-5 text-gray-900" />
                    <div className="absolute size-10 rounded-full bg-white/50 ring-1 shadow-lg ring-black/5"></div>
                    <div
                      style={{
                        animationDelay: '3s',
        ...
        <div className="col-span-2 my-auto px-2">
          ...
          <p className="mt-4 text-balance text-gray-700">{second.description}</p>
        </div>
        <div className="relative col-span-2 flex items-center justify-center overflow-hidden">
          <svg className="absolute size-full" aria-hidden="true">
            <defs>
              <pattern id={patternIdB} patternUnits="userSpaceOnUse" width="64" height="64">
                {Array.from({ length: 17 }, (_, i) => {
                  const offset = i * 8
                  return (
                    <path
            ...
            <rect width="100%" height="100%" fill={`url(#${patternIdB})`} />
          </svg>
        ...
        <div className="col-span-2 my-auto px-2">
          ...
          <p className="mt-4 text-balance text-gray-700">{third.description}</p>
        </div>
        <div className="relative col-span-2 flex items-center justify-center overflow-hidden">
          <svg className="absolute size-full [mask-image:linear-gradient(white_10rem,transparent)]" aria-hidden="true">
            <defs>
              <pattern id={patternIdC} patternUnits="userSpaceOnUse" width="64" height="64">
                {Array.from({ length: 17 }, (_, i) => {
                  const offset = i * 8
                  return (
                    <path
            ...
            <rect width="100%" height="100%" fill={`url(#${patternIdC})`} />
          </svg>
